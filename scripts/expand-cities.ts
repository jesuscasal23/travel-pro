...
const NEW_CITIES: NewCity[] = [
  ...
  { city: "Leon", country: "Spain", countryCode: "ES", lat: 42.60, lng: -5.57 },
...
console.log(`${NEW_CITIES.length} total new cities, ${NEW_CITIES.length - newEntries.length} duplicates skipped, ${newEntries.length} to add.`);
