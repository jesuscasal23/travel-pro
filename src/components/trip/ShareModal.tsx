...
export function ShareModal({ open, onOpenChange, shareUrl, isLoading, tripTitle }: ShareModalProps) {
  ...
  function handleEmail() {
    ...
    const body = encodeURIComponent(`I planned a trip with Travel Pro! Check it out:\n\n${shareUrl}`);
