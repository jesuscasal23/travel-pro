...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 z-50 w-[90%] max-w-md -translate-x-1/2 rounded-full bg-white/85 shadow-[0_8px_24px_rgba(44,47,49,0.06)] backdrop-blur-xl dark:bg-slate-900/85">
