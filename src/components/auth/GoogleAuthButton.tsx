...
export function GoogleAuthButton({ next, disabled = false, onError }: GoogleAuthButtonProps) {
  ...
  return (
    <button
      ...
      className="flex w-full items-center justify-center gap-3 rounded-[18px] border border-[#d7e3ff] bg-[#f8fbff] px-4 py-3.5 text-sm font-semibold text-[#1b2b4b] shadow-[0_12px_24px_rgba(27,43,75,0.04)] transition hover:border-[#bfd2ff] hover:bg-white disabled:cursor-not-allowed disabled:opacity-60"
    >
