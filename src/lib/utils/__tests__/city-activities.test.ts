...
const baseItinerary: Itinerary = {
  route: [
    ...
    { id: "osaka", city: "Osaka", country: "Japan", lat: 34.69, lng: 135.50, days: 2, countryCode: "JP" },
  ],
  days: [
    { day: 1, date: "Oct 1", city: "Tokyo", activities: [{ name: "Senso-ji", category: "culture", icon: "⛩️", why: "Great", duration: "2h" }] },
    { day: 2, date: "Oct 2", city: "Tokyo", activities: [{ name: "Shibuya", category: "explore", icon: "🏙️", why: "Fun", duration: "3h" }] },
