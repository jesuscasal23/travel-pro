...
export const POST = apiHandler("POST /api/v1/trips/:id/generate-activities", async (req, params) => {
  ...
  // Generate activities
  const updatedDays = await generateCityActivities(profile as UserProfile, intent, itinerary, cityId);
