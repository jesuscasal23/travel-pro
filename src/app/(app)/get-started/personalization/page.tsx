      ...
      <div className="relative flex h-dvh flex-col">
        <div className="flex-1 overflow-y-auto px-6 pb-6">
          ...
          <section className="flex min-h-full flex-col items-center px-4 pt-8 text-center">
            ...
            <h1 className="font-display text-ink mt-4 text-[2.55rem] leading-[1.02] font-bold tracking-[-0.05em]">
              Your travel style
              <br />
              is <span className="text-brand-primary">unique</span>
            </h1>

            <p className="text-dim mt-4 max-w-[290px] text-[15px] leading-7">
            ...
            <ul className="mt-8 w-full max-w-[280px] space-y-3 text-left">
              {highlights.map((highlight) => (
                <li key={highlight} className="flex items-start gap-3">
                  ...
                  <span className="text-steel text-[15px] leading-6 font-semibold">
                    {highlight}
                  </span>
                </li>
              ))}
