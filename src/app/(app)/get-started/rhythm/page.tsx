              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center gap-4 rounded-[30px] px-4 py-4 text-left transition-all ${
                    isSelected
                      ? "border-brand-primary-border-strong text-heading border bg-white shadow-[var(--shadow-brand-md)]"
                      : "text-heading border border-transparent bg-white/70"
                  }`}
                >
                  <div
        ...
        <div className="shrink-0 px-6 pt-3 pb-[calc(1.5rem+env(safe-area-inset-bottom))]">
          <button
            ...
            className={`flex w-full items-center justify-center gap-3 rounded-[24px] px-6 py-5 text-lg font-bold text-white transition-transform duration-200 active:scale-[0.985] ${
              !pace ? "bg-disabled cursor-not-allowed shadow-none" : "bg-ink shadow-dark-cta"
            }`}
          >
            <span>Continue</span>
