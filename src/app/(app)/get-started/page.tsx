...
export default function LandingPage() {
  ...
  return (
    <div className="relative h-dvh overflow-hidden bg-[image:var(--gradient-page-soft)]">
      ...
      <div className="relative flex h-dvh flex-col">
        <div className="flex-1 overflow-y-auto px-6 pb-6">
          ...
          <div className="pt-6">
            <p className="text-dim mx-auto max-w-[320px] text-center text-[15px] leading-7">
        ...
        <div className="shrink-0 px-6 pt-3 pb-[calc(1.5rem+env(safe-area-inset-bottom))]">
          ...
          {canInstall ? (
            <button
              ...
              className="text-dim hover:text-navy mx-auto mt-3 block text-sm font-semibold transition-colors"
            >
              Install app
            </button>
          ) : null}
