        ...
        <section>
          <div className="mb-4 flex items-center justify-between">
            <div>
              ...
              <h2 className="text-v2-dark mt-1 text-[1.4rem] font-bold tracking-[-0.04em]">
                Keep moving
              </h2>
            </div>
            <span className="text-v2-label text-[11px] font-bold tracking-[0.18em] uppercase">
          ...
          <div className="space-y-3">
            {nextSteps.map((step) => (
              ...
              >
                ...
                <p className="text-v2-heading flex-1 text-[15px] font-semibold tracking-[-0.02em]">
                  {step.label}
                </p>
